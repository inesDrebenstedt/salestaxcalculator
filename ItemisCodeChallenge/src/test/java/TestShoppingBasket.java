...
import main.java.util.AllSalesTaxesCalculator;
import main.java.util.BasicSalesTaxCalculator;
	...
	private static boolean isImported = true;
	  ...
	  public void testCalculateSalesTaxesOfBasket1() {
		  ...
		  Double salesTaxOfBasket1 = 
				  BasicSalesTaxCalculator.calculateSalesTaxesOfBasket(basket1);
	  ...
	  public void testBasket2Calculations() {
		  ...
		  Double totalOfBasket2WithoutTaxes = 
				  BasketTotalWithoutTaxesCalculator.calculateBasketTotalWithoutTaxes(basket2);
		  assertEquals(57.50, totalOfBasket2WithoutTaxes, 0.001);
		  
		  Double basket2SalesTaxes = 
				  BasicSalesTaxCalculator.calculateSalesTaxesOfBasket(basket2);
		  assertEquals(4.75, basket2SalesTaxes, 0.001);
		  
		  Double basket2ImportTaxes = 
				  ImportTaxCalculator.calculateImportTaxesOfBasket(basket2);
		  assertEquals(2.90, basket2ImportTaxes, 0.001);
		  
		  Double basket2AllSalesTaxes = 
				  AllSalesTaxesCalculator.calculateAllSalesTaxes(basket2);
		  assertEquals(7.65, basket2AllSalesTaxes, 0.001);
		  
		  Double basket2Total = 
				  BasketTotalCalculator.calculateTotalSumOfBasket(basket2);
	  ...
	  public void testBasket3Calculations() {
		  ...
		  Double totalOfBasket3WithoutTaxes = 
				  BasketTotalWithoutTaxesCalculator.calculateBasketTotalWithoutTaxes(basket3);
		  assertEquals(67.98, totalOfBasket3WithoutTaxes, 0.001);
		  
		  Double basket3SalesTaxes = 
				  BasicSalesTaxCalculator.calculateSalesTaxesOfBasket(basket3);
		  assertEquals(4.70, basket3SalesTaxes, 0.001);
		  
		  Double basket3ImportTaxes = 
				  ImportTaxCalculator.calculateImportTaxesOfBasket(basket3);
		  assertEquals(2.00, basket3ImportTaxes, 0.001);
		  
		  Double basket3AllSalesTaxes = 
				  AllSalesTaxesCalculator.calculateAllSalesTaxes(basket3);
		  assertEquals(6.70, basket3AllSalesTaxes, 0.001);
		  
		  Double basket3Total = 
				  BasketTotalCalculator.calculateTotalSumOfBasket(basket3);
